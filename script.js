...
const addLinkToPage = (link) => {
  const element = document.getElementById("added-links");
  ...
  tdActions.innerHTML = `<button class="btn remove-button" onclick="removeLink('${link}')" title="Remover ${link}"><i class="fa-solid fa-trash"></i></button>`;
